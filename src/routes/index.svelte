	...
	<div class="mx-auto flex max-w-5xl p-6">
		<div class="m-1 h-12 text-zinc-800 dark:text-zinc-200">
			...
			<p class="pt-4">
				...
				and growing my thoughts continuosly. This site serves as my place where I 📚 <a class="hover:underline font-semibold"
					href="https://www.swyx.io/learn-in-public/">learn in public</a
				>
				and grow my 💻🌱 <a class="hover:underline font-semibold" href="https://maggieappleton.com/garden-history">digital garden</a>.
			</p>
		</div>
		<div class="flex h-1/2 w-1/2 justify-center pl-2" id="photo">
			<img
				class="rounded-full shadow-[0_0_0_0.4rem_rgba(0,0,0,0.3)] dark:shadow-slate-100 shadow-slate-700"
...
<section class="bg-zinc-50 dark:bg-gray-900 pt-4">
	<div class="mx-auto max-w-5xl p-6">
			<h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-200">Recent Posts</h1>
			<ul class="mt-2 mx-auto">
				{#each posts as post}
					{#if post.status === 'published'}
						<li class="py-3 hover:bg-slate-300 dark:hover:bg-slate-500 px-2 rounded-lg">
							<span class="font-light text-sm rounded bg-gray-600 p-1 uppercase text-gray-200"
								>{post.type}</span
							>
							<a class="px-2 text-lg hover:underline dark:text-gray-300" href="/garden/{post.slug}">{post.title}</a>
