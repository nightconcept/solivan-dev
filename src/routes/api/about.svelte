...
<div class="mx-auto max-w-5xl p-6 text-zinc-800 dark:text-zinc-200">
	...
	<p class="pt-4">
		...
		>, and a web developer. By education, I am an electrical engineer with a soon-to-be masters in
	...
	<p class="pt-4">
		...
		realize that I am going to be a crappy writer if I don't start sooner. This <strike>blog</strike> digital garden is part of that
